...
const MyBooking = () => {
  ...
  return (
    <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
      <Title title='My Books' subTitle='Easily manage your past,current, and upcoming hostel reservation in one place.Plan your trips seamlessly with just a few clicks' align='left'/>
              ...
              <div key={booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t'>
                  {/* Hotel Details */}
                   ...
                   <div className=''>
                        ...
                        {!booking.isPaid &&(
                          <button className='px-4 py-1.5 mt-4 text-xs border border-gray-400 rounded-full hover:bg-gray-300 transition-all cursor-pointer'>
                            Pay Now
                          </button>
                        )}
                   </div>
